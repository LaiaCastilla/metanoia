        ...
        <div className="contact__content container-fluid">
          ...
          <div className="contact__content--text">
            ...
            <div className="contact__content--text-paragraph">
              Que vous dire sur moi ? Je m’appelle Audrey et que j’ai 31 ans.
              Cela peut paraitre bien jeune, mais croyez-moi mon âme n’a pas
              choisi la facilité dans cette nouvelle incarnation ! ce sont des
              années marquées par les leçons de vie qui m’ont fait grandir à
              vitesse grand V et m’ont révélées déjà très tôt mon chemin de vie.
              <br /> <br />
              ...
              <br /> <br /> Alors me voilà emportée par le flot de la vie dans
              des études de commerce, qui ont tout de même veillées à ce que je
              ne m’éloigne pas trop de ma voie, avec des postes dans des
              services publics et des structures sociales et de soins. C’est là,
              au contacts des autres, que mon empathie bienveillante, ma
              capacité d’écoute et mon souhait d’apporter mon aide m’ont donné
              l’envie de faire plus. <br /> <br />
              ...
              d’hypnothérapeute en hypnose Ericksonienne, car pour moi on ne
              peut traiter sans prendre en compte la vue d’ensemble dans une
              démarche holistique. <br /> <br /> C’est ainsi que Metanoia
              Therapy est née et que nous allons ensemble écrire la suite de
              l’histoire…
            </div>
          </div>
        </div>
